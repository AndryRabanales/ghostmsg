...
export default function DashboardPage() {
    ...
    // Cierre de sesión manual (la sesión nunca expira sola).
    ...
    return (
        <>
            ...
            <div className="dashboard-page-container">
                ...
                {!loading && creator && (
                    <div>
                        <div className="fade-in-up" style={{ animationDelay: '0.1s', display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'flex-start' }}>
